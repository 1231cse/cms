...
if(isset($_POST["Submit"])){
  ...
  if(empty($PostTitle)){
    ...
    if (!empty($_FILES["Image"]["name"])) {
      $sql = "UPDATE posts
              SET title='$PostTitle', category='$Category', image='$Image', ImageUrl='$ImageUrl', post='$PostText'
              WHERE id='$SarchQueryParameter'";
    }else {
      $sql = "UPDATE posts
              SET title='$PostTitle', category='$Category', ImageUrl='$ImageUrl', post='$PostText'
              WHERE id='$SarchQueryParameter'";
    }
    ...
    <div class="offset-lg-1 col-lg-10" style="min-height:400px;">
      <?php
       ...
       while ($DataRows=$stmt->fetch()) {
         ...
         $ImageURLToBeUpdated = $DataRows['ImageUrl'];
        ...
        <div class="card bg-secondary text-light mb-3">
          <div class="card-body bg-dark">
            ...
            <div class="form-group">
              ...
              <label for="ImageUrl"> <span class="FieldInfo"> Image Url </span></label>
              <input class="form-control" type="text" name="ImageUrl" id="ImageUrl" 
              placeholder="Enter Image Url here" value="">
              </div>
            </div>
