...
if(isset($_POST["Submit"])){
  ...
  if(empty($PostTitle)){
    ...
    global $ConnectingDB;
    $sql = "INSERT INTO posts(datetime,title,category,author,image,ImageUrl,post)";
    $sql .= "VALUES(:dateTime,:postTitle,:categoryName,:adminName,:imageName,:ImageUrl,:postDescription)";
